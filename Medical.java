...
Admin: superuser
password: medicaluser
authentication number: Medical1234
*/
import java.awt.*;
...
class connect {
	...
	public Connection aconnect() { // Changed return type to Connection
		try {
    Class.forName("oracle.jdbc.driver.OracleDriver");
    con = DriverManager.getConnection(
        "jdbc:oracle:thin:@localhost:1521:XE", // ✅ SID/service name
        "Medical",                                          // ✅ DB user that owns the tables
        "medical"                                             // ✅ password for 'system' user
    );
...
class AboutPage extends JFrame implements ActionListener
{
	...
	public void showFrame()
	{
		...
		title.setIcon(new ImageIcon("images\\Picture1.jpg"));
...
class LoginPage extends JFrame implements ActionListener
{
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		//if boolean type variable b returns true then it is registered user
			if(usr.equals("superuser")&&psw.equals("medicaluser")||b==1||b==2)
			{
				if(rb1.isSelected())
				{
